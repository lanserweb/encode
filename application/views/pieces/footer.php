                                ...
                                <ul>
                                    <li class="text-field with-icon span3">
                                        ...
                                        <div class="input-prepend">
                                            <span class="add-on">
                                                <img src="/encodingArt/template/newencode/images/footer/author-footer.png" alt="" title=""/></span>
                                    ...
                                    <li class="text-field with-icon span3">
                                        ...
                                        <div class="input-prepend">
                                            <span class="add-on">
                                                <img src="/encodingArt/template/newencode/images/footer/envelope-footer.png" alt="" title=""/>
                                            </span>
                                    ...
                                    <li class="textarea-field with-icon span6">
                                        ...
                                        <div class="input-prepend">
                                            <span class="add-on">
                                                <img src="/encodingArt/template/newencode/images/footer/pencil-footer.png" alt="" title=""/>
                                            </span>
        ...
        <div class="container">
            <div class="row">
                <div class="left span6">
                    <p>
                        Copyright 2016 - <strong>Encoding Art</strong>
                    </p>
                </div>
